      ...
      <Container maxW="container.lg">
        <VStack align="start" gap={16}>
          <VStack align="start" gap={6} maxW="3xl">
            <Heading size="4xl" color="onSurface" letterSpacing="tighter" fontWeight="black">
              {t(`Legal.${translationKey}.title`)}
            </Heading>
            <Box px={3} py={1} borderRadius="full" bg="surfaceContainerHigh" borderWidth="1px" borderColor="outline">
              <Text color="onSurfaceVariant" fontSize="xs" fontFamily="mono" textTransform="uppercase" letterSpacing="widest">
                {t(`Legal.${translationKey}.lastUpdated`)}
              </Text>
            </Box>
            <Text color="onSurface" fontSize="lg" lineHeight="1.8" opacity={0.9}>
